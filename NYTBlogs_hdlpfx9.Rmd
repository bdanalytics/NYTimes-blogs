...
title: "NYTimes:Blogs:: Popular classification:: hdlpfx9"
author: "bdanalytics"
...
glb_entity_df[, "SectionName.nb"] <- sapply(1:nrow(glb_entity_df), function(rix) { 
    if ((str <- glb_entity_df[rix, "SectionName"]) != "") return (str)
...
glb_entity_df[, "SubsectionName.nb"] <- sapply(1:nrow(glb_entity_df), function(rix) {
    ...
    if ((glb_entity_df[rix, "NewsDesk"] == "Business") &
        (glb_entity_df[rix, "Headline.pfx"] == "Today in (Politics|Small Business)::"))
...
#print(subset(ndsecsub_xtab_df, NewsDesk == "Business"))
