...
title: "NYTimes:Blogs:: Popular classification:: hdlpfx7"
author: "bdanalytics"
...
```{r inspectORexplore.data, cache=FALSE}
...
## Step ``r glb_script_df[nrow(glb_script_df), "chunk_step_major"]``: partition training data into fit & OOB
...
## Step ``r glb_script_df[nrow(glb_script_df), "chunk_step_major"]``: fit.data.training
