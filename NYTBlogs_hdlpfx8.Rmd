...
title: "NYTimes:Blogs:: Popular classification:: hdlpfx8"
author: "bdanalytics"
...
glb_entity_df[, "NewsDesk.nb"] <- sapply(1:nrow(glb_entity_df), 
    function(rix) ifelse((str <- glb_entity_df[rix, "NewsDesk"]) == "", 
                         glb_entity_df[rix, "Headline.pfx"], str))
mycheck_map_results(glb_entity_df, "NewsDesk", "NewsDesk.nb")
...
glb_entity_df[, "SectionName.nb"] <- sapply(1:nrow(glb_entity_df), 
    function(rix) ifelse((str <- glb_entity_df[rix, "SectionName"]) == "", 
        ifelse(glb_entity_df[rix, "NewsDesk"] == "OpEd", "Opinion", 
               glb_entity_df[rix, "NewsDesk.nb"]), 
                         str))
...
glb_entity_df[, "SubsectionName.nb"] <- sapply(1:nrow(glb_entity_df), 
    function(rix) ifelse((str <- glb_entity_df[rix, "SubsectionName"]) == "", 
            paste(glb_entity_df[rix, "NewsDesk.nb"], 
...
for (method in glb_models_method_vctr) {
    if (method != "rf") # skip the scenario w/ .rnorm
