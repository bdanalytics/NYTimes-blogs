...
PubDate = strptime(glb_entity_df$PubDate, "%Y-%m-%d %H:%M:%S")
#print(head(PubDate$year))
#print(head(PubDate$wday))
print(head(PubYear <- as.numeric(format(PubDate, "%Y"))))
print(head(PubMonth <- as.numeric(format(PubDate, "%m"))))
print(head(PubDt <- as.numeric(format(PubDate, "%d"))))
print(head(PubWkdy <- format(PubDate, "%a")))
print(head(PubHour <- as.numeric(format(PubDate, "%H"))))
print(head(PubMin <- as.numeric(format(PubDate, "%M"))))
print(head(PubSec <- as.numeric(format(PubDate, "%S"))))
